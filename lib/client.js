...
Client.prototype.setExtraHTTPHeaders = function(extraHTTPHeaders) {
...
Client.prototype._invoke = function(method, arguments, location, callback) {
    ...
    if (this.extraHTTPHeaders) {
        for (var header in this.extraHTTPHeaders) {
            if (this.extraHTTPHeaders.hasOwnProperty(header)) {
                headers[header] = this.extraHTTPHeaders[header];
            }
        }
    }
